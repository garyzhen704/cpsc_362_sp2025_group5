...
let wingSound = new Audio("/static/sounds/sfx_wing.wav");
let hitSound = new Audio("/static/sounds/sfx_hit.wav");
...
window.onload = function(){
    ...
    for (let i = 0; i < 4; i++){
        ...
        birdImg.src = `/static/images/flappybird${i}.png`; // Updated path
        birdImgs.push(birdImg);
    }

    topPipeImg = new Image();
    topPipeImg.src = `/static/images/toppipe.png`; // Updated path

    bottomPipeImg = new Image();
    bottomPipeImg.src = `/static/images/bottompipe.png`; // Updated path
